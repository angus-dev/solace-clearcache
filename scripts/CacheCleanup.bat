...
@rem ##########################################################################
@rem
@rem  CacheCleanup startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CACHE_CLEANUP_OPTS to pass JVM options to this script.
...
@rem Execute CacheCleanup
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CACHE_CLEANUP_OPTS%  -classpath "%CLASSPATH%" com.solace.test.CacheCleanup %CMD_LINE_ARGS%
...
:fail
rem Set variable CACHE_CLEANUP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CACHE_CLEANUP_EXIT_CONSOLE%" exit 1
exit /b 1
