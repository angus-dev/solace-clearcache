...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BASIC_REPLIER_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.BasicReplier %CMD_LINE_ARGS%
...
if  not "" == "%BASIC_REPLIER_EXIT_CONSOLE%" exit 1
exit /b 1
