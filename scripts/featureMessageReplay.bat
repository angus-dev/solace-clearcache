...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_MESSAGE_REPLAY_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.MessageReplay %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_MESSAGE_REPLAY_EXIT_CONSOLE%" exit 1
exit /b 1
