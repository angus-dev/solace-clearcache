...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_MESSAGE_SELECTORS_ON_QUEUE_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.MessageSelectorsOnQueue %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_MESSAGE_SELECTORS_ON_QUEUE_EXIT_CONSOLE%" exit 1
exit /b 1
