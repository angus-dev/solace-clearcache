...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_QUEUE_PROVISION_AND_REQUEST_ACTIVE_FLOW_INDICATION_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.QueueProvisionAndRequestActiveFlowIndication %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_QUEUE_PROVISION_AND_REQUEST_ACTIVE_FLOW_INDICATION_EXIT_CONSOLE%" exit 1
exit /b 1
