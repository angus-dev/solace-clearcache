...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %QUEUE_PRODUCER_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.QueueProducer %CMD_LINE_ARGS%
...
if  not "" == "%QUEUE_PRODUCER_EXIT_CONSOLE%" exit 1
exit /b 1
