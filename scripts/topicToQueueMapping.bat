...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TOPIC_TO_QUEUE_MAPPING_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.TopicToQueueMapping %CMD_LINE_ARGS%
...
if  not "" == "%TOPIC_TO_QUEUE_MAPPING_EXIT_CONSOLE%" exit 1
exit /b 1
