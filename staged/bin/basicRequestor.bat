...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BASIC_REQUESTOR_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.BasicRequestor %CMD_LINE_ARGS%
...
if  not "" == "%BASIC_REQUESTOR_EXIT_CONSOLE%" exit 1
exit /b 1
