...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONFIRMED_PUBLISH_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.ConfirmedPublish %CMD_LINE_ARGS%
...
if  not "" == "%CONFIRMED_PUBLISH_EXIT_CONSOLE%" exit 1
exit /b 1
