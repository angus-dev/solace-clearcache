...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_MESSAGE_TTL_AND_DEAD_MESSAGE_QUEUE_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.MessageTTLAndDeadMessageQueue %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_MESSAGE_TTL_AND_DEAD_MESSAGE_QUEUE_EXIT_CONSOLE%" exit 1
exit /b 1
