...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_QUEUE_PROVISION_AND_BROWSE_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.QueueProvisionAndBrowse %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_QUEUE_PROVISION_AND_BROWSE_EXIT_CONSOLE%" exit 1
exit /b 1
