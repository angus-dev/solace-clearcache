...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FEATURE_TRANSACTIONS_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.features.Transactions %CMD_LINE_ARGS%
...
if  not "" == "%FEATURE_TRANSACTIONS_EXIT_CONSOLE%" exit 1
exit /b 1
