...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %QUEUE_CONSUMER_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.QueueConsumer %CMD_LINE_ARGS%
...
if  not "" == "%QUEUE_CONSUMER_EXIT_CONSOLE%" exit 1
exit /b 1
