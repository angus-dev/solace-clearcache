...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TOPIC_SUBSCRIBER_OPTS%  -classpath "%CLASSPATH%" com.solace.samples.TopicSubscriber %CMD_LINE_ARGS%
...
if  not "" == "%TOPIC_SUBSCRIBER_EXIT_CONSOLE%" exit 1
exit /b 1
